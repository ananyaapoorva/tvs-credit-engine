...
from app.utils.constants import (
    ECOMMERCE_AOV_POINTS,
    ECOMMERCE_DURATION_POINTS,
    ECOMMERCE_FREQUENCY_POINTS,
    ECOMMERCE_HIGH_AOV,
    ECOMMERCE_HIGH_FREQUENCY,
    ECOMMERCE_HIGH_MONTHS,
    ECOMMERCE_LOW_RETURN_RATE,
    ECOMMERCE_MAX_POINTS,
    ECOMMERCE_RETURN_POINTS,
    ECOMMERCE_WEIGHT,
    GST_CONSISTENCY_POINTS,
    GST_FREQUENCY_POINTS,
    GST_HIGH_CONSISTENCY,
    GST_HIGH_MONTHS,
    GST_HIGH_RISK_BUSINESS_TYPES,
    GST_HIGH_TURNOVER,
    GST_MAX_POINTS,
    GST_RISK_DEDUCTION,
    GST_TURNOVER_POINTS,
    ...
    MIN_SCORE,
    MOBILITY_CONSISTENCY_POINTS,
    MOBILITY_DURATION_POINTS,
    MOBILITY_HIGH_MONTHS,
    MOBILITY_MAX_POINTS,
    MOBILITY_MIN_FUEL_EXPENSE,
    MOBILITY_OWNERSHIP_POINTS,
    MOBILITY_WEIGHT,
    TELECOM_AMOUNT_POINTS,
    TELECOM_CONSISTENCY_POINTS,
    TELECOM_GAPS_POINTS,
    TELECOM_HIGH_CONSISTENCY,
    TELECOM_HIGH_MONTHS,
    TELECOM_HISTORY_POINTS,
    TELECOM_MAX_POINTS,
    TELECOM_MIN_RECHARGE,
    TELECOM_WEIGHT,
    TOTAL_DATA_FIELDS,
    UPI_AVG_SIZE_POINTS,
    UPI_AVG_SIZE_THRESHOLD,
    UPI_DURATION_POINTS,
    UPI_FREQUENCY_POINTS,
    UPI_HIGH_FREQUENCY,
    UPI_HIGH_MONTHS,
    UPI_HIGH_VOLUME,
    UPI_MAX_POINTS,
    UPI_VOLUME_POINTS,
    UPI_WEIGHT,
    UTILITY_BILL_AMOUNT_POINTS,
    UTILITY_HIGH_MONTHS,
    UTILITY_HIGH_TIMELINESS,
    UTILITY_HISTORY_POINTS,
    UTILITY_MAX_POINTS,
    UTILITY_MIN_BILL,
    UTILITY_PATTERN_POINTS,
    UTILITY_TIMELINESS_POINTS,
    UTILITY_WEIGHT,
    VEHICLE_TYPE_SCORES,
)
